...
#newest: qcd leptonic enriched, 1 ttbar, 1 w+jets,  and drell-yan 
#TEMPORARY
leptonic_samples_2018 = [
    MCSample('qcdmupt15_2018', '/QCD_Pt-20toInf_MuEnrichedPt15_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',    22165320, nice='QCD, #hat{p}_{T} > 20 GeV, #mu p_{T} > 15 GeV', color=801, syst_frac=0.20, xsec=2.394e5),
    MCSample('qcdempt015_2018',      '/QCD_Pt-15to20_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2/MINIAODSIM',    14578212, nice='QCD,  15 < #hat{p}_{T} <  20 GeV, EM enriched', color=801, syst_frac=0.20, xsec=1.327e6),
    MCSample('qcdempt020_2018',      '/QCD_Pt-20to30_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',         14255377, nice='QCD,  20 < #hat{p}_{T} <  30 GeV, EM enriched', color=801, syst_frac=0.20, xsec=4.897e6),
    MCSample('qcdempt030_2018',      '/QCD_Pt-30to50_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2/MINIAODSIM',    15086084, nice='QCD,  30 < #hat{p}_{T} <  50 GeV, EM enriched', color=801, syst_frac=0.20, xsec=6.379e6),
    MCSample('qcdempt050_2018',      '/QCD_Pt-50to80_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',         10798233, nice='QCD,  50 < #hat{p}_{T} <  80 GeV, EM enriched', color=801, syst_frac=0.20, xsec=1.984e6),
    MCSample('qcdempt080_2018',      '/QCD_Pt-80to120_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',         9648791, nice='QCD,  80 < #hat{p}_{T} < 120 GeV, EM enriched', color=801, syst_frac=0.20, xsec=3.665e5),
    MCSample('qcdempt120_2018',      '/QCD_Pt-120to170_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',        9964143, nice='QCD, 120 < #hat{p}_{T} < 170 GeV, EM enriched', color=801, syst_frac=0.20, xsec=6.649e4),
    MCSample('qcdempt170_2018',      '/QCD_Pt-170to300_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',        3712174, nice='QCD, 170 < #hat{p}_{T} < 300 GeV, EM enriched', color=801, syst_frac=0.20, xsec=1.648e4),
    MCSample('qcdempt300_2018',       '/QCD_Pt-300toInf_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',        2901355, nice='QCD, #hat{p}_{T} > 300 GeV, EM enriched',       color=801, syst_frac=0.20, xsec=1097.0),
    MCSample('qcdbctoept015_2018',    '/QCD_Pt_15to20_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM',               4316068, nice='QCD,  15 < #hat{p}_{T} <  20 GeV, HF electrons', color=801, syst_frac=0.20, xsec=1.862e5),
    MCSample('qcdbctoept020_2018',    '/QCD_Pt_20to30_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM',              10561226, nice='QCD,  20 < #hat{p}_{T} <  30 GeV, HF electrons', color=801, syst_frac=0.20, xsec=3.038e5),
    MCSample('qcdbctoept030_2018',    '/QCD_Pt_30to80_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',              15177630, nice='QCD,  30 < #hat{p}_{T} <  80 GeV, HF electrons', color=801, syst_frac=0.20, xsec=3.623e5),
    MCSample('qcdbctoept080_2018',    '/QCD_Pt_80to170_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',             14934946, nice='QCD,  80 < #hat{p}_{T} < 170 GeV, HF electrons', color=801, syst_frac=0.20, xsec=3.37e4),
    MCSample('qcdbctoept170_2018',    '/QCD_Pt_170to250_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',             9654492, nice='QCD, 170 < #hat{p}_{T} < 250 GeV, HF electrons', color=801, syst_frac=0.20, xsec=2.125e3),
    MCSample('qcdbctoept250_2018',    '/QCD_Pt_250toInf_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',            10191317, nice='QCD, #hat{p}_{T} > 250 GeV, HF electrons',       color=801, syst_frac=0.20, xsec=562.5),
]

qcd_samples_2018 = [
  #  MCSample('qcdht0200_2018', '/QCD_HT200to300_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',   54289442, nice = 'QCD, 200 < H_{T} < 300 GeV',   color=802, syst_frac=0.20, xsec=1.551e6),
  #  MCSample('qcdht0300_2018', '/QCD_HT300to500_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',   54661579, nice = 'QCD, 300 < H_{T} < 500 GeV',   color=803, syst_frac=0.20, xsec=3.234e5),
   # MCSample('qcdht0500_2018', '/QCD_HT500to700_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',   55152960, nice = 'QCD, 500 < H_{T} < 700 GeV',   color=804, syst_frac=0.20, xsec=3.014e4),
    MCSample('qcdht0700_2018', '/QCD_HT700to1000_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',  48158738, nice = 'QCD, 700 < H_{T} < 1000 GeV',  color=805, syst_frac=0.20, xsec=6.344e3),
    MCSample('qcdht1000_2018', '/QCD_HT1000to1500_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 15466225, nice = 'QCD, 1000 < H_{T} < 1500 GeV', color=806, syst_frac=0.20, xsec=1.092e3),
    MCSample('qcdht1500_2018', '/QCD_HT1500to2000_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 10955087, nice = 'QCD, 1500 < H_{T} < 2000 GeV', color=807, syst_frac=0.20, xsec=99.76),
    MCSample('qcdht2000_2018', '/QCD_HT2000toInf_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',   5475677, nice = 'QCD, H_{T} > 2000',            color=808, syst_frac=0.20, xsec=20.35),
]
...
ttbar_samples_2018 = [
    MCSample('ttbar_2018', '/TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2/MINIAODSIM', 142155064, nice='t#bar{t}', color=600, syst_frac=0.15, xsec=831.76),
...
wjet_samples_2018 = [
    MCSample('wjetstolnu_2018', '/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM', 71026861, nice='W+Jets #rightarrow l#nu', color = 803, syst_frac=0.10, xsec=5.29e4),
    MCSample('wjetstolnu_ht0400_2018', '/WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 5932701, nice='W+Jets, 400 < H_{T} < 600 GeV', color = 803, syst_frac=0.20, xsec=57.48),
    MCSample('wjetstolnu_ht0600_2018', '/WJetsToLNu_HT-600To800_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 19771294, nice='W+Jets, 600 < H_{T} < 800 GeV', color = 8003, syst_frac=0.20 , xsec=12.87),
    MCSample('wjetstolnu_ht0800_2018', '/WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 8402687, nice='W+Jets, 800 < H_{T} < 1200 GeV', color=803, syst_frac=0.20 , xsec=5.366),
    MCSample('wjetstolnu_ht1200_2018', '/WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 7633949, nice='W+Jets, 1200 < H_{T} < 2500 GeV', color=803, syst_frac=0.20 , xsec=1.074),
    MCSample('wjetstolnu_ht2500_2018', '/WJetsToLNu_HT-2500ToInf_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 3273980, nice='W+Jets, H_{T} . 2500 GeV', color=803, syst_frac=0.20 , xsec=0.008001),
]

    
drellyan_samples_2018 = [
    MCSample('dyjetstollM10_2018',    '/DYJetsToLL_M-10to50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM', 39392062, nice='DY + jets #rightarrow ll, 10 < M < 50 GeV', color= 29, syst_frac=0.10, xsec=1.58e4),
    MCSample('dyjetstollM50_2018',    '/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 100194597, nice='DY + jets #rightarrow ll, M > 50 GeV', color= 32, syst_frac=0.10, xsec=5.34e3),
]
...
## Associated Higgs; problem with this : no tau or mass -- will mess up current set up. Maybe need to filter and separate files before this stage. 
# mfv_zh_samples_2018 = [
#     MCSample('mfv_zh_4tau_ZToLL_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
#     MCSample('mfv_zh_bbbb_ZToLL_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
#     MCSample('mfv_zh_dddd_ZToLL_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
# ]

## make a path for the associated higgs;
## found nevents by running ntuples first. NOTE: there are more lifetimes than what I'm currently considering so added nevents_exclusive will not equal the inclusive sample
## dddd : 1506727
## have to keep total number of events when running ntuple.py 
ZH_HToSSTobbbb_ZToLL_samples_2018 = [
    MCSample('ZH_HToSSTobbbb_ZToll_tau000050um_M15_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau001000um_M15_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau010000um_M15_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau100000um_M15_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau000050um_M40_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau001000um_M40_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau010000um_M40_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau100000um_M40_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau000050um_M55_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau001000um_M55_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau010000um_M55_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
    MCSample('ZH_HToSSTobbbb_ZToll_tau100000um_M55_2018', '/ZH_HToSSTobbbb_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1123157),
]


ZH_HToSSTodddd_ZToLL_samples_2018 = [
    MCSample('ZH_HToSSTodddd_ZToll_tau000050um_M07_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau001000um_M07_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau010000um_M07_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau100000um_M07_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau000050um_M15_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau001000um_M15_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau010000um_M15_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau100000um_M15_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau000050um_M40_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau001000um_M40_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau010000um_M40_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau100000um_M40_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau000050um_M55_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau001000um_M55_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau010000um_M55_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
    MCSample('ZH_HToSSTodddd_ZToll_tau100000um_M55_2018', '/ZH_HToSSTodddd_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1506727),
]

ZH_HToSSTo4Tau_ZToLL_samples_2018 = [
    MCSample('ZH_HToSSTo4Tau_ZToll_tau000050um_M07_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau001000um_M07_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau010000um_M07_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau100000um_M07_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau000050um_M15_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau001000um_M15_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau010000um_M15_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau100000um_M15_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau000050um_M40_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau001000um_M40_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau010000um_M40_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau100000um_M40_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau000050um_M55_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau001000um_M55_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau010000um_M55_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
    MCSample('ZH_HToSSTo4Tau_ZToll_tau100000um_M55_2018', '/ZH_HToSSTo4Tau_ZToLL_MH-125_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-rp_102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 1549040),
]
...
all_signal_samples_2018 = mfv_stoplb_samples_2018 + mfv_stopld_samples_2018 #+ ZH_HToSSTodddd_ZToLL_samples_2018 + ZH_HToSSTobbbb_ZToLL_samples_2018 + ZH_HToSSTo4Tau_ZToLL_samples_2018
#all_signal_samples_2018 = ZH_HToSSTodddd_ZToLL_samples_2018 + ZH_HToSSTobbbb_ZToLL_samples_2018 + ZH_HToSSTo4Tau_ZToLL_samples_2018
...
semilept_lb_samples_2018 = [eval('mfv_stoplb_tau%06ium_M%04i_2018' % (a,b)) for a in (1000, 10000, 100000) for b in (200, 400, 600, 800, 1000, 1200, 1400, 1600, 1800)]
semilept_ld_samples_2018 = [eval('mfv_stopld_tau%06ium_M%04i_2018' % (a,b)) for a in (1000, 10000, 100000) for b in (200, 400, 600, 800, 1000, 1200, 1600, 1800)]
#hnl_trilept_samples_2018 = [eval('hnl_trilept_%s_tau%06ium_M%04i_2018' % (a,b,c)) for a in ('e', 'mu') for b in ( ) for c in ( )]
assoc_higgs_a_samples_2018 = [eval('ZH_HToSSTo%s_ZToll_tau%06ium_M%02i_2018' % (a,b,c)) for a in ('dddd', '4Tau') for b in (50, 1000, 10000, 100000) for c in (7, 15, 40, 55)]
assoc_higgs_b_samples_2018 = [eval('ZH_HToSSTobbbb_ZToll_tau%06ium_M%2i_2018' % (a,b)) for a in (50, 1000, 10000, 100000) for b in (15, 40, 55)] 

_alls = [
    'all_signal_samples_2017',
    'all_signal_samples_2018',
    #'extra_signal_samples_2018',
    'span_signal_samples_2017',
    'span_signal_samples_2018',
    'semilept_lb_samples_2018',
    'semilept_ld_samples_2018',
    'assoc_higgs_a_samples_2018',
    'assoc_higgs_b_samples_2018'
...
#_adbp('miniaod', '/QCD_Pt-20toInf_MuEnrichedPt15_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',    22165320)
# _adbp('miniaod', '/QCD_Pt-15to20_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2/MINIAODSIM',    14578212)
# _adbp('miniaod', '/QCD_Pt-20to30_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',         14255377)
# _adbp('miniaod', '/QCD_Pt-30to50_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2/MINIAODSIM',    15086084)
# _adbp('miniaod', '/QCD_Pt-50to80_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',         10798233)
# _adbp('miniaod', '/QCD_Pt-80to120_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',         9648791)
# _adbp('miniaod', '/QCD_Pt-120to170_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',        9964143)
# _adbp('miniaod', '/QCD_Pt-170to300_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',        3712174)
# _adbp('miniaod', '/QCD_Pt-300toInf_EMEnriched_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',        2901355)
# _adbp('miniaod', '/QCD_Pt_15to20_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM',               4316068)
# _adbp('miniaod', '/QCD_Pt_20to30_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM',              10561226)
# _adbp('miniaod', '/QCD_Pt_30to80_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',              15177630)
# _adbp('miniaod', '/QCD_Pt_80to170_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',             14934946)
# _adbp('miniaod', '/QCD_Pt_170to250_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',             9654492)
# _adbp('miniaod', '/QCD_Pt_250toInf_bcToE_TuneCP5_13TeV_pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',            10191317)

# _adbp('miniaod', '/QCD_HT200to300_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',   54289442)
...
# _adbp('miniaod', '/QCD_HT700to1000_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',  48158738)
# _adbp('miniaod', '/QCD_HT1000to1500_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 15466225)
...
# _adbp('miniaod', '/ZZ_TuneCP5_13TeV-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM', 1979000)
# _adbp('miniaod', '/WW_TuneCP5_13TeV-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM', 7850000)
# _adbp('miniaod', '/WZ_TuneCP5_13TeV-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v3/MINIAODSIM', 3885000)
# _adbp('miniaod', '/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM', 71026861)
# _adbp('miniaod', '/WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 5932701)
# _adbp('miniaod', '/WJetsToLNu_HT-600To800_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 19771294)
# _adbp('miniaod', '/WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 8402687)
# _adbp('miniaod', '/WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 7633949)
# _adbp('miniaod', '/WJetsToLNu_HT-2500ToInf_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 3273980)

# _adbp('miniaod', '/DYJetsToLL_M-10to50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM', 39392062)
# _adbp('miniaod', '/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 100194597)
...
for sample in leptonic_samples_2018 :
    sample.add_dataset('miniaod', sample.dataset, sample.nevents_orig)
for sample in ZH_HToSSTobbbb_ZToLL_samples_2018 :
    sample.add_dataset('miniaod', sample.dataset, sample.nevents_orig)
for sample in ZH_HToSSTodddd_ZToLL_samples_2018 :
    sample.add_dataset('miniaod', sample.dataset, sample.nevents_orig)
for sample in ZH_HToSSTo4Tau_ZToLL_samples_2018 :
    sample.add_dataset('miniaod', sample.dataset, sample.nevents_orig)
...
for sample in qcd_samples_2018 :
    sample.add_dataset('miniaod', sample.dataset, sample.nevents_orig)
for sample in ttbar_samples_2018 :
    sample.add_dataset('miniaod', sample.dataset, sample.nevents_orig)
for sample in diboson_samples_2018 :
    sample.add_dataset('miniaod', sample.dataset, sample.nevents_orig)
for sample in wjet_samples_2018 :
    sample.add_dataset('miniaod', sample.dataset, sample.nevents_orig)
...
#ntuple Dec 15
#contains more info on displaced leptons : lxy, l, x, y, z & added muon isolation
# for x in qcdmupt15_2018, qcdempt015_2018, qcdempt020_2018, qcdempt030_2018, qcdempt050_2018, qcdempt080_2018, qcdempt120_2018, qcdempt170_2018, qcdempt300_2018, qcdbctoept015_2018, qcdbctoept020_2018, qcdbctoept030_2018, qcdbctoept080_2018, qcdbctoept170_2018, qcdbctoept250_2018, qcdht0700_2018, qcdht1000_2018, qcdht1500_2018, qcdht2000_2018, ttbar_2018, ttbarht0600_2018, ttbarht1200_2018, ttbarht2500_2018, zz_2018, ww_2018, wz_2018, wjetstolnu_2018, wjetstolnu_ht0400_2018, wjetstolnu_ht0800_2018, wjetstolnu_ht1200_2018, wjetstolnu_ht2500_2018, dyjetstollM10_2018, dyjetstollM50_2018, mfv_stoplb_tau001000um_M1000_2018, mfv_stoplb_tau010000um_M1000_2018, mfv_stoplb_tau100000um_M1000_2018, mfv_stoplb_tau001000um_M1200_2018, mfv_stoplb_tau010000um_M1200_2018, mfv_stoplb_tau100000um_M1200_2018, mfv_stoplb_tau001000um_M1400_2018, mfv_stoplb_tau010000um_M1400_2018, mfv_stoplb_tau100000um_M1400_2018, mfv_stoplb_tau001000um_M1600_2018, mfv_stoplb_tau010000um_M1600_2018, mfv_stoplb_tau100000um_M1600_2018, mfv_stoplb_tau001000um_M1800_2018, mfv_stoplb_tau010000um_M1800_2018, mfv_stoplb_tau100000um_M1800_2018, mfv_stoplb_tau001000um_M0200_2018, mfv_stoplb_tau010000um_M0200_2018, mfv_stoplb_tau100000um_M0200_2018, mfv_stoplb_tau001000um_M0400_2018, mfv_stoplb_tau010000um_M0400_2018, mfv_stoplb_tau100000um_M0400_2018, mfv_stoplb_tau001000um_M0600_2018, mfv_stoplb_tau010000um_M0600_2018, mfv_stoplb_tau100000um_M0600_2018, mfv_stoplb_tau001000um_M0800_2018, mfv_stoplb_tau010000um_M0800_2018, mfv_stoplb_tau100000um_M0800_2018, mfv_stopld_tau001000um_M1000_2018, mfv_stopld_tau010000um_M1000_2018, mfv_stopld_tau100000um_M1000_2018, mfv_stopld_tau001000um_M1200_2018, mfv_stopld_tau010000um_M1200_2018, mfv_stopld_tau100000um_M1200_2018, mfv_stopld_tau001000um_M1400_2018, mfv_stopld_tau010000um_M1400_2018, mfv_stopld_tau100000um_M1400_2018, mfv_stopld_tau001000um_M1600_2018, mfv_stopld_tau010000um_M1600_2018, mfv_stopld_tau100000um_M1600_2018, mfv_stopld_tau001000um_M1800_2018, mfv_stopld_tau010000um_M1800_2018, mfv_stopld_tau100000um_M1800_2018, mfv_stopld_tau001000um_M0200_2018, mfv_stopld_tau010000um_M0200_2018, mfv_stopld_tau100000um_M0200_2018, mfv_stopld_tau001000um_M0400_2018, mfv_stopld_tau010000um_M0400_2018, mfv_stopld_tau100000um_M0400_2018, mfv_stopld_tau001000um_M0600_2018, mfv_stopld_tau010000um_M0600_2018, mfv_stopld_tau100000um_M0600_2018, mfv_stopld_tau001000um_M0800_2018, mfv_stopld_tau010000um_M0800_2018, mfv_stopld_tau100000um_M0800_2018:
#     x.add_dataset("ntuplev29lepm")

#ntuple Jan 7
# fixed electron isolation calculation to be relative iso 
for x in qcdmupt15_2018, qcdempt015_2018, qcdempt020_2018, qcdempt030_2018, qcdempt050_2018, qcdempt080_2018, qcdempt120_2018, qcdempt170_2018, qcdempt300_2018, qcdbctoept015_2018, qcdbctoept020_2018, qcdbctoept030_2018, qcdbctoept080_2018, qcdbctoept170_2018, qcdbctoept250_2018, qcdht0700_2018, qcdht1000_2018, qcdht1500_2018, qcdht2000_2018, ttbar_2018, ttbarht0600_2018, ttbarht0800_2018, ttbarht1200_2018, ttbarht2500_2018, zz_2018, ww_2018, wz_2018, wjetstolnu_2018, wjetstolnu_ht0400_2018, wjetstolnu_ht0600_2018, wjetstolnu_ht0800_2018, wjetstolnu_ht1200_2018, wjetstolnu_ht2500_2018, dyjetstollM10_2018, dyjetstollM50_2018, mfv_stoplb_tau001000um_M1000_2018, mfv_stoplb_tau010000um_M1000_2018, mfv_stoplb_tau100000um_M1000_2018, mfv_stoplb_tau001000um_M1200_2018, mfv_stoplb_tau010000um_M1200_2018, mfv_stoplb_tau100000um_M1200_2018, mfv_stoplb_tau001000um_M1400_2018, mfv_stoplb_tau010000um_M1400_2018, mfv_stoplb_tau100000um_M1400_2018, mfv_stoplb_tau001000um_M1600_2018, mfv_stoplb_tau010000um_M1600_2018, mfv_stoplb_tau100000um_M1600_2018, mfv_stoplb_tau001000um_M1800_2018, mfv_stoplb_tau010000um_M1800_2018, mfv_stoplb_tau100000um_M1800_2018, mfv_stoplb_tau001000um_M0200_2018, mfv_stoplb_tau010000um_M0200_2018, mfv_stoplb_tau100000um_M0200_2018, mfv_stoplb_tau001000um_M0400_2018, mfv_stoplb_tau010000um_M0400_2018, mfv_stoplb_tau100000um_M0400_2018, mfv_stoplb_tau001000um_M0600_2018, mfv_stoplb_tau010000um_M0600_2018, mfv_stoplb_tau100000um_M0600_2018, mfv_stoplb_tau001000um_M0800_2018, mfv_stoplb_tau010000um_M0800_2018, mfv_stoplb_tau100000um_M0800_2018, mfv_stopld_tau001000um_M1000_2018, mfv_stopld_tau010000um_M1000_2018, mfv_stopld_tau100000um_M1000_2018, mfv_stopld_tau001000um_M1200_2018, mfv_stopld_tau010000um_M1200_2018, mfv_stopld_tau100000um_M1200_2018, mfv_stopld_tau010000um_M1400_2018, mfv_stopld_tau100000um_M1400_2018, mfv_stopld_tau001000um_M1600_2018, mfv_stopld_tau010000um_M1600_2018, mfv_stopld_tau100000um_M1600_2018, mfv_stopld_tau001000um_M1800_2018, mfv_stopld_tau010000um_M1800_2018, mfv_stopld_tau100000um_M1800_2018, mfv_stopld_tau001000um_M0200_2018, mfv_stopld_tau010000um_M0200_2018, mfv_stopld_tau100000um_M0200_2018, mfv_stopld_tau001000um_M0400_2018, mfv_stopld_tau010000um_M0400_2018, mfv_stopld_tau100000um_M0400_2018, mfv_stopld_tau001000um_M0600_2018, mfv_stopld_tau010000um_M0600_2018, mfv_stopld_tau100000um_M0600_2018, mfv_stopld_tau001000um_M0800_2018, mfv_stopld_tau010000um_M0800_2018, mfv_stopld_tau100000um_M0800_2018, ZH_HToSSTodddd_ZToll_tau001000um_M15_2018, ZH_HToSSTodddd_ZToll_tau010000um_M15_2018, ZH_HToSSTodddd_ZToll_tau100000um_M15_2018, ZH_HToSSTodddd_ZToll_tau001000um_M40_2018, ZH_HToSSTodddd_ZToll_tau010000um_M40_2018, ZH_HToSSTodddd_ZToll_tau100000um_M40_2018, ZH_HToSSTodddd_ZToll_tau001000um_M55_2018, ZH_HToSSTodddd_ZToll_tau010000um_M55_2018, ZH_HToSSTodddd_ZToll_tau100000um_M55_2018:
    x.add_dataset("ntuplev30lepm")  #mfv_stopld_tau001000um_M1400_2018,


#ntuple for corrected assoc Higgs sample production
for x in ZH_HToSSTobbbb_ZToll_tau000050um_M15_2018, ZH_HToSSTobbbb_ZToll_tau001000um_M15_2018, ZH_HToSSTobbbb_ZToll_tau010000um_M15_2018, ZH_HToSSTobbbb_ZToll_tau100000um_M15_2018, ZH_HToSSTobbbb_ZToll_tau000050um_M40_2018, ZH_HToSSTobbbb_ZToll_tau001000um_M40_2018, ZH_HToSSTobbbb_ZToll_tau010000um_M40_2018, ZH_HToSSTobbbb_ZToll_tau100000um_M40_2018, ZH_HToSSTobbbb_ZToll_tau000050um_M55_2018, ZH_HToSSTobbbb_ZToll_tau001000um_M55_2018, ZH_HToSSTobbbb_ZToll_tau010000um_M55_2018, ZH_HToSSTobbbb_ZToll_tau100000um_M55_2018, ZH_HToSSTodddd_ZToll_tau000050um_M07_2018, ZH_HToSSTodddd_ZToll_tau001000um_M07_2018, ZH_HToSSTodddd_ZToll_tau010000um_M07_2018, ZH_HToSSTodddd_ZToll_tau100000um_M07_2018, ZH_HToSSTodddd_ZToll_tau000050um_M15_2018, ZH_HToSSTodddd_ZToll_tau001000um_M15_2018, ZH_HToSSTodddd_ZToll_tau010000um_M15_2018, ZH_HToSSTodddd_ZToll_tau100000um_M15_2018, ZH_HToSSTodddd_ZToll_tau000050um_M40_2018, ZH_HToSSTodddd_ZToll_tau001000um_M40_2018, ZH_HToSSTodddd_ZToll_tau010000um_M40_2018, ZH_HToSSTodddd_ZToll_tau100000um_M40_2018, ZH_HToSSTodddd_ZToll_tau000050um_M55_2018, ZH_HToSSTodddd_ZToll_tau001000um_M55_2018, ZH_HToSSTodddd_ZToll_tau010000um_M55_2018, ZH_HToSSTodddd_ZToll_tau100000um_M55_2018, ZH_HToSSTo4Tau_ZToll_tau000050um_M07_2018, ZH_HToSSTo4Tau_ZToll_tau001000um_M07_2018, ZH_HToSSTo4Tau_ZToll_tau010000um_M07_2018, ZH_HToSSTo4Tau_ZToll_tau100000um_M07_2018, ZH_HToSSTo4Tau_ZToll_tau000050um_M15_2018, ZH_HToSSTo4Tau_ZToll_tau001000um_M15_2018, ZH_HToSSTo4Tau_ZToll_tau010000um_M15_2018, ZH_HToSSTo4Tau_ZToll_tau100000um_M15_2018, ZH_HToSSTo4Tau_ZToll_tau000050um_M40_2018, ZH_HToSSTo4Tau_ZToll_tau001000um_M40_2018, ZH_HToSSTo4Tau_ZToll_tau010000um_M40_2018, ZH_HToSSTo4Tau_ZToll_tau100000um_M40_2018, ZH_HToSSTo4Tau_ZToll_tau000050um_M55_2018, ZH_HToSSTo4Tau_ZToll_tau001000um_M55_2018, ZH_HToSSTo4Tau_ZToll_tau010000um_M55_2018, ZH_HToSSTo4Tau_ZToll_tau100000um_M55_2018:
    x.add_dataset("ntuplev30lepnoefm")

#ntuple for isolation
# for x in ttbar_2018, ttbarht0600_2018, ttbarht0800_2018, ttbarht1200_2018, ttbarht2500_2018, mfv_stoplb_tau001000um_M1000_2018, mfv_stoplb_tau010000um_M1000_2018, mfv_stoplb_tau100000um_M1000_2018, mfv_stoplb_tau001000um_M1200_2018, mfv_stoplb_tau010000um_M1200_2018, mfv_stoplb_tau100000um_M1200_2018, mfv_stoplb_tau001000um_M1400_2018, mfv_stoplb_tau010000um_M1400_2018, mfv_stoplb_tau100000um_M1400_2018, mfv_stoplb_tau001000um_M1600_2018, mfv_stoplb_tau100000um_M1600_2018, mfv_stoplb_tau001000um_M1800_2018, mfv_stoplb_tau010000um_M0200_2018, mfv_stoplb_tau001000um_M0400_2018, mfv_stoplb_tau010000um_M0400_2018, mfv_stoplb_tau100000um_M0400_2018, mfv_stoplb_tau001000um_M0600_2018, mfv_stoplb_tau100000um_M0600_2018, mfv_stoplb_tau001000um_M0800_2018, mfv_stoplb_tau010000um_M0800_2018, mfv_stoplb_tau100000um_M0800_2018, mfv_stopld_tau001000um_M1000_2018, mfv_stopld_tau010000um_M1000_2018, mfv_stopld_tau100000um_M1000_2018, mfv_stopld_tau001000um_M1200_2018, mfv_stopld_tau010000um_M1200_2018, mfv_stopld_tau010000um_M1400_2018, mfv_stopld_tau100000um_M1400_2018, mfv_stopld_tau010000um_M1600_2018, mfv_stopld_tau100000um_M1600_2018, mfv_stopld_tau001000um_M1800_2018, mfv_stopld_tau010000um_M1800_2018, mfv_stopld_tau100000um_M1800_2018, mfv_stopld_tau001000um_M0200_2018, mfv_stopld_tau100000um_M0200_2018, mfv_stopld_tau010000um_M0400_2018, mfv_stopld_tau100000um_M0400_2018, mfv_stopld_tau001000um_M0600_2018, mfv_stopld_tau010000um_M0600_2018, mfv_stopld_tau100000um_M0600_2018, mfv_stopld_tau001000um_M0800_2018, mfv_stopld_tau010000um_M0800_2018, mfv_stopld_tau100000um_M0800_2018:
#     x.add_dataset("ntuplev30lepisom")

#ntuple (select few) for n-1 geo2ddist; still need ttbar
for x in  mfv_stoplb_tau001000um_M1000_2018, mfv_stoplb_tau010000um_M1000_2018, mfv_stoplb_tau100000um_M1000_2018, ttbar_2018:
    x.add_dataset("ntuplev30lepisom")


#ntuple with sigma(dxy) >= 3 (relaxed cut)
for x in qcdht1000_2018, qcdht1500_2018, qcdht2000_2018, mfv_stoplb_tau001000um_M1000_2018, mfv_stoplb_tau010000um_M1000_2018, mfv_stoplb_tau100000um_M1000_2018, mfv_stoplb_tau001000um_M1200_2018, mfv_stoplb_tau010000um_M1200_2018, mfv_stoplb_tau100000um_M1200_2018, mfv_stoplb_tau001000um_M1400_2018, mfv_stoplb_tau010000um_M1400_2018, mfv_stoplb_tau100000um_M1400_2018, mfv_stoplb_tau001000um_M1600_2018, mfv_stoplb_tau010000um_M1600_2018, mfv_stoplb_tau100000um_M1600_2018, mfv_stoplb_tau001000um_M1800_2018, mfv_stoplb_tau010000um_M1800_2018, mfv_stoplb_tau100000um_M1800_2018, mfv_stoplb_tau001000um_M0200_2018, mfv_stoplb_tau010000um_M0200_2018, mfv_stoplb_tau100000um_M0200_2018, mfv_stoplb_tau001000um_M0400_2018, mfv_stoplb_tau010000um_M0400_2018, mfv_stoplb_tau100000um_M0400_2018, mfv_stoplb_tau001000um_M0600_2018, mfv_stoplb_tau010000um_M0600_2018, mfv_stoplb_tau100000um_M0600_2018, mfv_stoplb_tau001000um_M0800_2018, mfv_stoplb_tau010000um_M0800_2018, mfv_stoplb_tau100000um_M0800_2018, mfv_stopld_tau001000um_M1000_2018, mfv_stopld_tau010000um_M1000_2018, mfv_stopld_tau100000um_M1000_2018, mfv_stopld_tau001000um_M1200_2018, mfv_stopld_tau010000um_M1200_2018, mfv_stopld_tau100000um_M1200_2018, mfv_stopld_tau010000um_M1400_2018, mfv_stopld_tau100000um_M1400_2018, mfv_stopld_tau001000um_M1600_2018, mfv_stopld_tau010000um_M1600_2018, mfv_stopld_tau100000um_M1600_2018, mfv_stopld_tau001000um_M1800_2018, mfv_stopld_tau010000um_M1800_2018, mfv_stopld_tau100000um_M1800_2018, mfv_stopld_tau001000um_M0200_2018, mfv_stopld_tau010000um_M0200_2018, mfv_stopld_tau100000um_M0200_2018, mfv_stopld_tau001000um_M0400_2018, mfv_stopld_tau010000um_M0400_2018, mfv_stopld_tau100000um_M0400_2018, mfv_stopld_tau001000um_M0600_2018, mfv_stopld_tau010000um_M0600_2018, mfv_stopld_tau100000um_M0600_2018, mfv_stopld_tau001000um_M0800_2018, mfv_stopld_tau010000um_M0800_2018, mfv_stopld_tau100000um_M0800_2018:
    x.add_dataset("ntuplev30lepsigma3m")  #mfv_stopld_tau001000um_M1400_2018,

#ntuple with sigma(dxy) >= 2 (relaxed cut)
for x in mfv_stoplb_tau001000um_M1000_2018, mfv_stoplb_tau010000um_M1000_2018, mfv_stoplb_tau100000um_M1000_2018, mfv_stoplb_tau001000um_M1200_2018, mfv_stoplb_tau010000um_M1200_2018, mfv_stoplb_tau100000um_M1200_2018, mfv_stoplb_tau001000um_M1400_2018, mfv_stoplb_tau010000um_M1400_2018, mfv_stoplb_tau100000um_M1400_2018, mfv_stoplb_tau001000um_M1600_2018, mfv_stoplb_tau010000um_M1600_2018, mfv_stoplb_tau100000um_M1600_2018, mfv_stoplb_tau001000um_M1800_2018, mfv_stoplb_tau010000um_M1800_2018, mfv_stoplb_tau100000um_M1800_2018, mfv_stoplb_tau001000um_M0200_2018, mfv_stoplb_tau010000um_M0200_2018, mfv_stoplb_tau100000um_M0200_2018, mfv_stoplb_tau001000um_M0400_2018, mfv_stoplb_tau010000um_M0400_2018, mfv_stoplb_tau100000um_M0400_2018, mfv_stoplb_tau001000um_M0600_2018, mfv_stoplb_tau010000um_M0600_2018, mfv_stoplb_tau100000um_M0600_2018, mfv_stoplb_tau001000um_M0800_2018, mfv_stoplb_tau010000um_M0800_2018, mfv_stoplb_tau100000um_M0800_2018, mfv_stopld_tau001000um_M1000_2018, mfv_stopld_tau010000um_M1000_2018, mfv_stopld_tau100000um_M1000_2018, mfv_stopld_tau001000um_M1200_2018, mfv_stopld_tau010000um_M1200_2018, mfv_stopld_tau100000um_M1200_2018, mfv_stopld_tau010000um_M1400_2018, mfv_stopld_tau100000um_M1400_2018, mfv_stopld_tau001000um_M1600_2018, mfv_stopld_tau010000um_M1600_2018, mfv_stopld_tau100000um_M1600_2018, mfv_stopld_tau001000um_M1800_2018, mfv_stopld_tau010000um_M1800_2018, mfv_stopld_tau100000um_M1800_2018, mfv_stopld_tau001000um_M0200_2018, mfv_stopld_tau010000um_M0200_2018, mfv_stopld_tau100000um_M0200_2018, mfv_stopld_tau001000um_M0400_2018, mfv_stopld_tau010000um_M0400_2018, mfv_stopld_tau100000um_M0400_2018, mfv_stopld_tau001000um_M0600_2018, mfv_stopld_tau010000um_M0600_2018, mfv_stopld_tau100000um_M0600_2018, mfv_stopld_tau001000um_M0800_2018, mfv_stopld_tau010000um_M0800_2018, mfv_stopld_tau100000um_M0800_2018, qcdmupt15_2018, qcdempt015_2018, qcdempt020_2018, qcdempt030_2018, qcdempt050_2018, qcdempt080_2018, qcdempt120_2018, qcdempt170_2018, qcdempt300_2018, qcdbctoept015_2018, qcdbctoept020_2018, qcdbctoept030_2018, qcdbctoept080_2018, qcdbctoept170_2018, qcdbctoept250_2018, ttbar_2018, ttbarht0600_2018, ttbarht0800_2018, zz_2018, ww_2018, wz_2018, wjetstolnu_2018, wjetstolnu_ht0400_2018, wjetstolnu_ht0600_2018, wjetstolnu_ht0800_2018, wjetstolnu_ht1200_2018, wjetstolnu_ht2500_2018, dyjetstollM10_2018, dyjetstollM50_2018:
    x.add_dataset("ntuplev30lepsigma2m") # mfv_stopld_tau001000um_M1400_2018
...
condorable = {
    ...
    "T1_US_FNAL_Disk": {
        "miniaod": [qcdht1500_2017, qcdht2000_2017, dyjetstollM10_2017, #qcdmupt15_2017, qcdht0300_2018,
                    ttbarht0800_2018, qcdht1000_2018,
                    JetHT2017B, JetHT2017D, JetHT2017F, JetHT2018A, JetHT2018B, JetHT2018D,
                    zz_2018, wjetstolnu_ht0600_2018, qcdempt015_2018, qcdempt030_2018, qcdempt080_2018, qcdempt120_2018, qcdempt300_2018, qcdbctoept250_2018, dyjetstollM10_2018,
                    ...
                    mfv_neu_tau001000um_M0800_2018, mfv_stopdbardbar_tau000100um_M1600_2018, mfv_stopdbardbar_tau000300um_M0400_2018, mfv_stopdbardbar_tau000300um_M1600_2018, mfv_stopdbardbar_tau010000um_M1200_2018, mfv_stopdbardbar_tau010000um_M3000_2018, mfv_stopdbardbar_tau030000um_M1600_2018, SingleMuon2017F, mfv_stoplb_tau001000um_M1000_2018, mfv_stoplb_tau010000um_M1000_2018, mfv_stoplb_tau100000um_M1000_2018, mfv_stoplb_tau001000um_M1200_2018, mfv_stoplb_tau010000um_M1200_2018, mfv_stoplb_tau100000um_M1200_2018, mfv_stoplb_tau001000um_M1400_2018, mfv_stoplb_tau010000um_M1400_2018, mfv_stoplb_tau100000um_M1400_2018, mfv_stoplb_tau001000um_M1600_2018, mfv_stoplb_tau100000um_M1600_2018, mfv_stoplb_tau001000um_M1800_2018, mfv_stoplb_tau010000um_M0200_2018, mfv_stoplb_tau001000um_M0400_2018, mfv_stoplb_tau010000um_M0400_2018, mfv_stoplb_tau100000um_M0600_2018, mfv_stoplb_tau010000um_M0800_2018, mfv_stopld_tau010000um_M1000_2018, mfv_stopld_tau001000um_M1000_2018, mfv_stopld_tau001000um_M1200_2018, mfv_stopld_tau100000um_M1400_2018, mfv_stopld_tau010000um_M1400_2018, mfv_stopld_tau100000um_M1800_2018, mfv_stopld_tau010000um_M1800_2018, mfv_stopld_tau100000um_M0200_2018, mfv_stopld_tau100000um_M0400_2018, mfv_stopld_tau010000um_M0400_2018, mfv_stopld_tau010000um_M0600_2018, mfv_stopld_tau001000um_M0600_2018, mfv_stopld_tau001000um_M0800_2018, mfv_stopld_tau010000um_M0800_2018, ggHToSSTobbbb_tau10mm_M15_2017, ggHToSSTodddd_tau1mm_M15_2017, ggHToSSTodddd_tau1000mm_M40_2017, ZH_HToSSTodddd_ZToll_tau000050um_M15_2018, ZH_HToSSTodddd_ZToll_tau001000um_M15_2018, ZH_HToSSTodddd_ZToll_tau010000um_M15_2018, ZH_HToSSTodddd_ZToll_tau100000um_M15_2018, ZH_HToSSTodddd_ZToll_tau000050um_M40_2018, ZH_HToSSTodddd_ZToll_tau001000um_M40_2018, ZH_HToSSTodddd_ZToll_tau010000um_M40_2018, ZH_HToSSTodddd_ZToll_tau100000um_M40_2018, ZH_HToSSTodddd_ZToll_tau000050um_M55_2018, ZH_HToSSTodddd_ZToll_tau001000um_M55_2018, ZH_HToSSTodddd_ZToll_tau010000um_M55_2018, ZH_HToSSTodddd_ZToll_tau100000um_M55_2018, ZH_HToSSTodddd_ZToll_tau000050um_M07_2018, ZH_HToSSTodddd_ZToll_tau001000um_M07_2018, ZH_HToSSTodddd_ZToll_tau010000um_M07_2018, ZH_HToSSTodddd_ZToll_tau100000um_M07_2018],
        },
    "T2_DE_DESY": {
        "miniaod": [JetHT2017C, JetHT2017E, JetHT2018C, SingleMuon2017D, qcdmupt15_2018],
        },
    "T2_US_MIT": {
        "miniaod": [ww_2018, wjetstolnu_ht0400_2018, #qcdht0500_2018,
                    qcdempt170_2018, ttHbb_2017, mfv_stopld_tau010000um_M1600_2018, mfv_stopld_tau100000um_M0600_2018, ggHToSSTobbbb_tau1000mm_M40_2017, ggHToSSTobbbb_tau100mm_M40_2017, ggHToSSTodddd_tau1000mm_M15_2017, ggHToSSTodddd_tau1mm_M55_2017],
        },
    "T2_US_Florida": {
        "miniaod": [wjetstolnu_ht0800_2018, qcdempt020_2018, qcdbctoept020_2018, qcdbctoept170_2018, ttZext_2017, qcdht0700_2017, qcdht0500_2017, mfv_stoplb_tau100000um_M0400_2018, mfv_stopld_tau100000um_M1600_2018, mfv_stopld_tau001000um_M1800_2018, mfv_stopld_tau001000um_M0200_2018, mfv_stopld_tau100000um_M0800_2018], #qcdht0200_2018,
        },
    "T2_US_Nebraska": {
        "miniaod": [SingleMuon2017C, wjetstolnu_ht2500_2018, qcdempt050_2018, qcdbctoept030_2018, dyjetstollM50_2018, ttbar_2017, qcdht0300_2017, mfv_neu_tau030000um_M1600_2017, mfv_stoplb_tau010000um_M1600_2018, mfv_stoplb_tau010000um_M1800_2018, mfv_stoplb_tau100000um_M1800_2018, mfv_stoplb_tau001000um_M0200_2018, mfv_stoplb_tau100000um_M0200_2018, mfv_stopld_tau001000um_M1400_2018, mfv_stoplb_tau010000um_M0600_2018, mfv_stopld_tau100000um_M1200_2018, mfv_stopld_tau001000um_M1600_2018, mfv_stopld_tau010000um_M0200_2018, mfv_stopld_tau001000um_M0400_2018, ggHToSSTodddd_tau10mm_M40_2017, ggHToSSTodddd_tau1000mm_M55_2017, ggHToSSTodddd_tau100mm_M55_2017], #mfv_stopld_tau001000um_M1400_2018
        },
    "T2_US_Purdue": {
        "miniaod": [wz_2018, qcdht0700_2018, qcdbctoept015_2018, wjetstolnu_ht1200_2018, mfv_stopdbardbar_tau000100um_M1200_2017,  mfv_stoplb_tau001000um_M0600_2018, mfv_stopld_tau010000um_M1200_2018, ggHToSSTobbbb_tau1000mm_M15_2017, ggHToSSTobbbb_tau100mm_M15_2017, ggHToSSTobbbb_tau1mm_M15_2017, ggHToSSTobbbb_tau10mm_M40_2017, ggHToSSTobbbb_tau1mm_M40_2017, ggHToSSTobbbb_tau1000mm_M55_2017, ggHToSSTobbbb_tau100mm_M55_2017, ggHToSSTobbbb_tau1mm_M55_2017, ggHToSSTodddd_tau100mm_M15_2017, ggHToSSTodddd_tau10mm_M15_2017, ggHToSSTodddd_tau100mm_M40_2017, ggHToSSTodddd_tau1mm_M40_2017, ggHToSSTodddd_tau10mm_M55_2017, ZH_HToSSTobbbb_ZToll_tau000050um_M15_2018, ZH_HToSSTobbbb_ZToll_tau001000um_M15_2018, ZH_HToSSTobbbb_ZToll_tau010000um_M15_2018, ZH_HToSSTobbbb_ZToll_tau100000um_M15_2018, ZH_HToSSTobbbb_ZToll_tau000050um_M40_2018, ZH_HToSSTobbbb_ZToll_tau001000um_M40_2018, ZH_HToSSTobbbb_ZToll_tau010000um_M40_2018, ZH_HToSSTobbbb_ZToll_tau100000um_M40_2018, ZH_HToSSTobbbb_ZToll_tau000050um_M55_2018, ZH_HToSSTobbbb_ZToll_tau001000um_M55_2018, ZH_HToSSTobbbb_ZToll_tau010000um_M55_2018, ZH_HToSSTobbbb_ZToll_tau100000um_M55_2018],
        },
    "T2_US_Wisconsin" : {
        "miniaod": [ttZ_2017, mfv_stopdbardbar_tau000300um_M0600_2017, ggHToSSTobbbb_tau10mm_M55_2017, qcdbctoept080_2018, ttbar_2018, wjetstolnu_2018, mfv_stoplb_tau001000um_M0800_2018, mfv_stoplb_tau100000um_M0800_2018, mfv_stopld_tau100000um_M1000_2018, ZH_HToSSTo4Tau_ZToll_tau000050um_M07_2018, ZH_HToSSTo4Tau_ZToll_tau001000um_M07_2018, ZH_HToSSTo4Tau_ZToll_tau010000um_M07_2018, ZH_HToSSTo4Tau_ZToll_tau100000um_M07_2018, ZH_HToSSTo4Tau_ZToll_tau000050um_M15_2018, ZH_HToSSTo4Tau_ZToll_tau001000um_M15_2018, ZH_HToSSTo4Tau_ZToll_tau010000um_M15_2018, ZH_HToSSTo4Tau_ZToll_tau100000um_M15_2018, ZH_HToSSTo4Tau_ZToll_tau000050um_M40_2018, ZH_HToSSTo4Tau_ZToll_tau001000um_M40_2018, ZH_HToSSTo4Tau_ZToll_tau010000um_M40_2018, ZH_HToSSTo4Tau_ZToll_tau100000um_M40_2018, ZH_HToSSTo4Tau_ZToll_tau000050um_M55_2018, ZH_HToSSTo4Tau_ZToll_tau001000um_M55_2018, ZH_HToSSTo4Tau_ZToll_tau010000um_M55_2018, ZH_HToSSTo4Tau_ZToll_tau100000um_M55_2018],
        },
    }
...
for s in mfv_signal_samples_2017 + mfv_signal_samples_2018 + mfv_stopdbardbar_samples_2017 + mfv_stopdbardbar_samples_2018+ mfv_stoplb_samples_2018 + mfv_stopld_samples_2018:
    if s not in _seen:
