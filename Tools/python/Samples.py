...
assoc_higgs_a_samples_2018 = [eval('ZH_HToSSTo%s_ZToll_tau%06ium_M%02i_2018' % (a,b,c)) for a in ('dddd', '4Tau') for b in (1000, 10000, 100000) for c in (15, 40, 55)]
...
condorable = {
    ...
    "T2_US_Wisconsin" : {
        "miniaod": [ttZ_2017, mfv_stopdbardbar_tau000300um_M0600_2017, ggHToSSTobbbb_tau10mm_M55_2017, qcdbctoept080_2018, ttbar_2018, wjetstolnu_2018, mfv_stoplb_tau001000um_M0800_2018, mfv_stoplb_tau100000um_M0800_2018, mfv_stopld_tau100000um_M1000_2018],
        },
    }
