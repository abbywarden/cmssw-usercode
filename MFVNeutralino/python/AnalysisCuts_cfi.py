...
mfvAnalysisCuts = cms.EDFilter('MFVAnalysisCuts',
                              ...
                              # apply_presel = cms.int32(4) if use_btag_triggers else cms.int32(1),  # 1 = jets, 2 = el/mu, 3 = jets OR bjet/displaced dijet triggers, 4 = bjet/displaced dijet triggers veto HT trigger
                               ...
                               apply_singleel_trig = cms.bool(False),
                               apply_singlemu_trig = cms.bool(False),
                               apply_doubleel_trig = cms.bool(False),
                               apply_doublemu_trig = cms.bool(False),
                               apply_doublemuel_trig = cms.bool(False),
                               ...
                               apply_lept_cuts = cms.bool(True),
                               apply_vertex_cuts = cms.bool(True),
                               apply_displept_cuts = cms.bool(False),
                               min_dxy = cms.double(0.005),
