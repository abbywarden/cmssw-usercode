...
class MFVCutFlowHistos : public edm::EDAnalyzer {
 ...
 private:
  ...
  enum {atleast_1vtx, pass_mintrack, pass_inbeampipe, pass_mindbv, pass_maxdbv_unc, atleast_2vtx, pass_2mintrack, pass_2inbeampipe, pass_2mindbv, pass_2maxdbv_unc};
    ...
    weight_token(consumes<double>(cfg.getParameter<edm::InputTag>("weight_src")))
{
  ...
  h_vertex_cutflow = fs->make<TH1D>("h_vtx_sel_cutflow", ";events", 10, 0, 10);
  int nbin = 1;
  for (const char* n : {"atleast_1vtx", "pass_min4trk", "pass_inbeampipe", "pass_mindbv", "pass_maxdbv_unc", "atleast_2vtx", "pass_2min4trk", "pass_2inbeampipe", "pass_2mindbv", "pass_2maxdbv_unc"})
