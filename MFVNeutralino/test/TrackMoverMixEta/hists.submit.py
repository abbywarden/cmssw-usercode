          ...
          if apply_correction:
            for tm in ["sim",]: #"dat"] :
              ...
              if tm == "sim":
                ...
                w_fn_2d_move = "reweight_v2p4_mixeta_move_sim_vetodr_tau%06ium_M%02i_%s_2D.root" % (tau, mg, year) 
              else:
                ...
                w_fn_2d_move = "reweight_v2p4_mixeta_move_dat_vetodr_tau%06ium_M%02i_%s_2D.root" % (tau, mg, year) 
              batch_tag = "2Dmovedist3movedist2jetdrllpsumpcoarse60alletasoftupCorrection"
              w_fn_2d_kin = "reweight_v2p4_alletasoftup_kin_sim_vetodr_tau%06ium_M%02i_2D.root" % (tau, mg) 
