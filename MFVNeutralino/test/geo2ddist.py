...
#f = ROOT.TFile('/afs/hep.wisc.edu/home/acwarden/crabdirs/HistosV30Lepm_matchTrig_wfull/mfv_stoplb_tau001000um_M1000_%s.root' % year)
f = ROOT.TFile('/afs/hep.wisc.edu/home/acwarden/crabdirs/HistosV30Lepm_matchTrig_wfull/mfv_stoplb_tau100000um_M1800_%s.root' % year)

#f = ROOT.TFile('/afs/hep.wisc.edu/home/acwarden/crabdirs/HistosV30Lepm_matchTrig_wfull/ttbar_%s.root' % year)

#h = f.Get('vtxHst1VNoGeo2ddist/h_sv_pos_bs2dxy')

#h = f.Get('MinNtk4vtxHst1VNoBsbs2ddist/h_sv_xy')
h = f.Get('MinNtk3vtxHst1VNogeo2ddist/h_sv_xy')
...
ps.save('onevtx_geo2ddist_tau100mm')
