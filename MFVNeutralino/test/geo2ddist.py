...
f = ROOT.TFile('/afs/hep.wisc.edu/home/acwarden/crabdirs/HistosV30Lepisom_fullsel_CR/ttbar_%s.root' % year)
...
h = f.Get('MinNtk4vtxHst1VNogeo2ddist/h_sv_xy')
...
ps.save('onevtx_geo2ddist_ttbar')
