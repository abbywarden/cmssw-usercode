...
variables = ['_movedist2_','_ht_','_njets_', '_nmuons_', '_neles_', '_ele_pT', '_ele_abseta_', '_ele_iso_', '_ele_absdxybs_', '_met_pT_', '_w_mT_', '_w_pT_', 'wjet_dphi', 'lnu_absphi', 'ljet_absphi', 'nujet_absphi', '_jet_asymm_','_vtx_unc_','_jet_dr_','_jet_deta_','_jet_dphi_','_jet_dind_','_pt0_','_pt1_','_ntks_j0_','_ntks_j1_','_nmovedtracks_','_dphi_sum_j_mv_'] 
...
def comp(ex, fn1='data.root', fn2='ttbar.root', fn3='mergedqcd.root', fn4='dyjets.root', fn5 = 'wjets_amcatnlo.root', fn6 = 'signal.root', Isshort='dummy', whichlep='Muon'):
    assert ex
    ...
    for name in l:
        ...
        if name.endswith('_den'): #or (not name.endswith('_num') and not name.endswith('_den')):
            ...
            signal.SetName("MC (W->lnu)H->SS 1mm 55GeV 2017")
            #mc4.ClearUnderflowAndOverflow()
            ...
            x_range = None
            y_range = None
            hist_objs = [data, mc4, mc3, mc2, mc, signal]
