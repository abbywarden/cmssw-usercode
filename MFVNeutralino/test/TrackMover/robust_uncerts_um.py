...
for mass in masses:
    ...
    for ctau in ctaus:
        ...
        for psd_method in psd_methods:
                ...
                signal  = ROOT.TFile('~/nobackup/crabdirs/TrackMoverMCTruth_StudyMinijets_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30lepmumv6/WplusHToSSTodddd_tau'+str(int(ctau))+'um_M'+ mass +'_'+ year +'.root')
                signal_jetht  = ROOT.TFile('~/nobackup/crabdirs/TrackMoverMCTruth_StudyMinijets_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30lepmumv6/WplusHToSSTodddd_tau'+str(int(ctau))+'um_M'+ mass +'_'+ year +'.root')
                if mass == '15': 
                    signal_non  = ROOT.TFile('~/nobackup/crabdirs/TrackMoverMCTruth_StudyMinijets_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkVetoOdVV0p5JetByMiniJetHistsOnnormdzUlv30lepmumv6/WplusHToSSTodddd_tau'+str(int(ctau))+'um_M'+ mass +'_'+ year +'.root')
                elif mass == '40':
                    signal_non  = ROOT.TFile('~/nobackup/crabdirs/TrackMoverMCTruth_StudyMinijets_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkVetoOdVV0p25JetByMiniJetHistsOnnormdzUlv30lepmumv6/WplusHToSSTodddd_tau'+str(int(ctau))+'um_M'+ mass +'_'+ year +'.root')
                else :
                    signal_non  = ROOT.TFile('~/nobackup/crabdirs/TrackMoverMCTruth_StudyMinijets_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkVetoOdVVJetByMiniJetHistsOnnormdzUlv30lepmumv6/WplusHToSSTodddd_tau'+str(int(ctau))+'um_M'+ mass +'_'+ year +'.root')
