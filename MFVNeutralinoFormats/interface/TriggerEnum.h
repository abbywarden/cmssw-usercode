...
namespace mfv {
  ...
  enum {
    b_HLT_PFHT1050, b_HLT_Ele32_WPTight_Gsf, b_HLT_IsoMu24, b_HLT_Mu50, b_HLT_Ele15_IsoVVVL_PFHT450, b_HLT_Mu15_IsoVVVL_PFHT450,
  ...
  static const std::vector<size_t> LeptonOrDisplacedLeptonTriggers = {
    ...
    //mfv::b_HLT_Ele15_IsoVVVL_PFHT450, mfv::b_HLT_Mu15_IsoVVVL_PFHT450,
